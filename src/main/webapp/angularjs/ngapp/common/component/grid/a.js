...
function loadPageBeginHtml() {
    currentBlogApp && $.ajax({
        ...
        contentType: "application/json; charset=utf-8",
        success: function (n) {
            n && (n.indexOf("<script") > -1 ? $.getScript("http://common.cnblogs.com/script/jquery.writeCapture-min.js", function () {
...
function loadBlogNews() {
    $.ajax({
        ...
        dataType: "text",
        success: function (n) {
            n && (n.indexOf("<script") < n.indexOf('<script type="text/javascript">cnblogs.UserManager.') ? $.getScript("http://common.cnblogs.com/script/jquery.writeCapture-min.js", function () {
...
function getBlogPostBody(n) {
    $.ajax({
        ...
        dataType: "text",
        success: function (t) {
            t ? ($("#postlist_postbody_" + n).html(t), cb_CodeHighlight(), cb_mathjax_render(), fixPostListBodyFormat(), n > 3861237 && $.getScript("http://common.cnblogs.com/highlight/highlight.min.js", function () {
...
function google_ga() {
    try {
        google_analytics(window, document, "script", "//www.google-analytics.com/analytics.js", "ga");
        ga("create", "UA-476124-1", "auto");
        ga("send", "pageview")
    } catch (n) {
    }
}
function deliverTextAd() {
    var t = $("#cb_post_title_url"), n;
    t.length && (n = $(t).html(), n.length > 200 && (n = n.substr(0, 200)), $.ajax({
        url: "http://ad.cnblogs.com/text/postbodypage",
        type: "get",
        data: {content: n},
        cache: !1,
        dataType: "jsonp",
        success: function (n) {
            new Date < new Date("Jan 1, 2015") && (n += '<br/><a href="http://www.ucancode.com/index.htm" target="_blank">【推荐】50万行VC++源码: 大型组态\\工控、电力仿真CAD\\GIS源码库<\/a>');
            new Date < new Date("Dec 1, 2014") && (n += '<br/><a href="http://www.rongcloud.cn/promotion/" target="_blank">融云，免费为你的App加入IM功能——让你的App“聊”起来！！<\/a>');
            new Date < new Date("Oct 31, 2014") && (n += '<br/><a href="http://zt.cnblogs.com/tingyun/" target="_blank">听云APP性能监测 —— 终结移动App性能黑洞<\/a>');
            $("#site_nav_under").html(n)
        }
    }))
}
function deliverTextAd_New() {
    var t = $("#cb_post_title_url"), n;
    t.length && (n = $(t).html(), n.length > 200 && (n = n.substr(0, 200)), $.ajax({
        url: "http://ad.cnblogs.com/ad/postmoduletext",
        type: "get",
        data: {adModuleId: 2, content: n},
        dataType: "jsonp",
        success: function (n) {
            $("#site_nav_under").html(n)
        }
