...
(function(_CONSTANTS) {
    ...
    var _CACHE_KEY = (function () {
        function CACHE_KEY() {
        }

        CACHE_KEY.USER_UNIT_CODE = "USER_UNIT_CODE";
        CACHE_KEY.USER_NAME = "USER_NAME";
        CACHE_KEY.USER_PASSWORD = "USER_PASSWORD";
    ...
    _CONSTANTS.CACHE_KEY = _CACHE_KEY;
