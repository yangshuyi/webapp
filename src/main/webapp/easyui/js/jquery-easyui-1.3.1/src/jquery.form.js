...
//			}
	...
	/**
	 * load com.echodrama.form data
	 * if data is a URL string type load from remote site, 
	 * otherwise load from local data object. 
	 */
	function load(target, data){
		if (!$.data(target, 'com.echodrama.form')){
			$.data(target, 'com.echodrama.form', {
				options: $.extend({}, $.fn.form.defaults)
			});
		}
		var opts = $.data(target, 'com.echodrama.form').options;
	...
	/**
	 * clear the com.echodrama.form fields
	 */
	...
	/**
	 * set the com.echodrama.form to make it can submit with ajax.
	 */
	function setForm(target){
		var options = $.data(target, 'com.echodrama.form').options;
		var form = $(target);
		form.unbind('.com.echodrama.form').bind('submit.com.echodrama.form', function(){
			setTimeout(function(){
...
//	}
	...
	$.fn.form = function(options, param){
		...
		return this.each(function(){
			if (!$.data(this, 'com.echodrama.form')){
				$.data(this, 'com.echodrama.form', {
