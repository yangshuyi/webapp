...
function _b(_c,_d){
if(!$.data(_c,"com.echodrama.form")){
$.data(_c,"com.echodrama.form",{options:$.extend({},$.fn.form.defaults)});
}
var _e=$.data(_c,"com.echodrama.form").options;
if(typeof _d=="string"){
var _f={};
...
function _20(_21){
var _22=$.data(_21,"com.echodrama.form").options;
var _23=$(_21);
_23.unbind(".com.echodrama.form").bind("submit.com.echodrama.form",function(){
setTimeout(function(){
_1(_21,_22);
},0);
return false;
...
$.data(this,"com.echodrama.form",{options:$.extend({},$.fn.form.defaults,_26)});
}
_20(this);
});
};
