angular.module('dashboardModule').controller('dashboardProductCtrl', ['$scope', '$stateParams', 'dashboardService',
    function ($scope, $stateParams, dashboardService) {

        $scope.navToRiskAssessmentPage = function () {

        };

        $scope.navToScorePage = function () {
